...
void ::Model_Viewer_3d::App::InitializeComponent()
{
#if defined _DEBUG && !defined DISABLE_XAML_GENERATED_BREAK_ON_UNHANDLED_EXCEPTION
...
::Windows::UI::Xaml::Markup::IXamlType^ ::Model_Viewer_3d::App::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return _AppProvider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::Model_Viewer_3d::App::GetXamlType(::Platform::String^ fullName)
{
    return _AppProvider->GetXamlTypeByName(fullName);
}

::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::Model_Viewer_3d::App::GetXmlnsDefinitions()
{
    return ref new ::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::Model_Viewer_3d::App::_AppProvider::get()
{
...
int __cdecl main(::Platform::Array<::Platform::String^>^ args)
{
    ...
    ::Windows::UI::Xaml::Application::Start(ref new ::Windows::UI::Xaml::ApplicationInitializationCallback(
        [](::Windows::UI::Xaml::ApplicationInitializationCallbackParams^ p) {
            ...
            auto app = ref new ::Model_Viewer_3d::App();
        }));
}
#endif
