#include "pch.h"
#include "Model_Viewer_3dMain.h"
#include "Common\DirectXHelper.h"

using namespace Model_Viewer_3d;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// Ładuje i inicjuje zasoby aplikacji podczas ładowania aplikacji.
Model_Viewer_3dMain::Model_Viewer_3dMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
Model_Viewer_3dMain::~Model_Viewer_3dMain()
{
...
void Model_Viewer_3dMain::CreateWindowSizeDependentResources() 
{
	// TODO: Zastąp to zależnym od rozmiaru inicjowaniem zawartości aplikacji.
	m_sceneRenderer->CreateWindowSizeDependentResources();
}

void Model_Viewer_3dMain::StartRenderLoop()
{
...
void Model_Viewer_3dMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Aktualizuje stan aplikacji raz na klatkę.
void Model_Viewer_3dMain::Update() 
{
	ProcessInput();
...
void Model_Viewer_3dMain::ProcessInput()
{
...
bool Model_Viewer_3dMain::Render() 
{
...
void Model_Viewer_3dMain::OnDeviceLost()
{
...
void Model_Viewer_3dMain::OnDeviceRestored()
{
